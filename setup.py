...
PACKAGENAME = metadata.get('package_name', 'quickspec')
DESCRIPTION = metadata.get(
    'description', 'Code to estimate the angular power spectra of cosmic fields')
AUTHOR = metadata.get('author', 'Daniel Lenz')
AUTHOR_EMAIL = metadata.get('author_email', 'mail@daniellenz.org')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/DanielLenz/quickspec')
...
setup_requires = ['astropy', 'scipy', 'numpy']
